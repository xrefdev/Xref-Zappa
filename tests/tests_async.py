...
from xrefzappa.asynchronous import AsyncException, LambdaAsyncResponse, SnsAsyncResponse
from xrefzappa.asynchronous import import_and_get_task, get_func_task_path
...
class TestZappa(unittest.TestCase):
    ...
    def test_async_call_with_defaults(self):
        ...
        with mock.patch.dict('xrefzappa.asynchronous.ASYNC_CLASSES',
